  ...
  (func (export "eval") (param $pc i32)
    ...
    (block $endLoop
      (loop $loop
        ...
        (local.set $pc (i32.and (i32.add (local.get $pc) (i32.const 1)) (i32.const 0xffff)))
        ...
        (local.set $wstp (i32.and (i32.add (local.get $wstp) (i32.const 1)) (i32.const 0xff)))
        (local.set $pc (i32.and (i32.add (local.get $pc) (local.get $t)) (i32.const 0xffff)))
        (br $loop)
        ...
        (local.set $pc (i32.and (i32.add (local.get $pc) (select (local.get $t) (i32.const 0) (local.get $n))) (i32.const 0xffff)))
        (br $loop)
        ...
        ;;;
        (local.set $t (i32.load8_s offset=0x100000 (local.get $wstp)))
        (i32.store8 offset=0x100000 (local.get $wstp) (i32.load8_u (i32.and (i32.add (local.get $pc) (local.get $t)) (i32.const 0xffff))))
        (br $loop)
        ...
        (local.set $n (i32.load8_u offset=0x100000 (i32.and (i32.add (local.get $wstp) (i32.const 1)) (i32.const 0xff))))
        (local.set $wstp (i32.and (i32.add (local.get $wstp) (i32.const 2)) (i32.const 0xff)))
        (i32.store8 (i32.and (i32.add (local.get $pc) (local.get $t)) (local.get $n) (i32.const 0xffff)))
        (br $loop)
        ...
        (local.set $t (i32.load8_u offset=0x100000 (local.get $wstp)))
        (local.set $wstp (i32.and (i32.add (local.get $wstp) (i32.const 1)) (i32.const 0xff)))
        (if (local.get $t) (then (local.set $pc (i32.and (i32.add (i32.const 2) (i32.and (i32.add (local.get $pc) (i32.or (i32.shl (i32.load8_u (local.get $pc)) (i32.const 8)) (i32.load8_u (i32.and (i32.add (local.get $pc) (i32.const 1)) (i32.const 0xffff))))) (i32.const 0xffff))) (i32.const 0xffff)))) (else (local.set $pc (i32.and (i32.add (local.get $pc) (i32.const 2)) (i32.const 0xffff)))))
        (br $loop)
        ...
        (local.set $t (i32.or (i32.load8_u offset=0x100000 (local.get $wstp)) (i32.shl (i32.load8_u offset=0x100000 (i32.and (i32.add (local.get $wstp) (i32.const 1)) (i32.const 0xff))) (i32.const 8))))
        (local.set $wstp (i32.and (i32.add (local.get $wstp) (i32.const 2)) (i32.const 0xff)))
        (local.set $pc (i32.and (local.get $t) (i32.const 0xffff)))
        (br $loop)
        ...
        (local.set $n (i32.load8_u offset=0x100000 (i32.and (i32.add (local.get $wstp) (i32.const 2)) (i32.const 0xff))))
        (local.set $wstp (i32.and (i32.add (local.get $wstp) (i32.const 3)) (i32.const 0xff)))
        (local.set $pc (i32.and (select (local.get $t) (local.get $pc) (local.get $n)) (i32.const 0xffff)))
        (br $loop)
        ...
        (local.set $t (i32.load8_s offset=0x100000 (local.get $wstp)))
        (local.set $wstp (i32.and (i32.add (local.get $wstp) (i32.const 255)) (i32.const 0xff)))
        (i32.store8 offset=0x100000 (i32.and (i32.add (local.get $wstp) (i32.const 1)) (i32.const 0xff)) (i32.load8_u (local.tee $mval (i32.and (i32.add (local.get $pc) (local.get $t)) (i32.const 0xffff)))))
        ...
        ;;;
        (local.set $pc (i32.and (i32.add (i32.const 2) (i32.and (i32.add (local.get $pc) (i32.or (i32.shl (i32.load8_u (local.get $pc)) (i32.const 8)) (i32.load8_u (i32.and (i32.add (local.get $pc) (i32.const 1)) (i32.const 0xffff))))) (i32.const 0xffff))) (i32.const 0xffff)))
        (br $loop)
        ...
        ;;;
        (local.set $t (i32.load8_s offset=0x100100 (local.get $rstp)))
        (i32.store8 offset=0x100100 (local.get $rstp) (i32.load8_u (i32.and (i32.add (local.get $pc) (local.get $t)) (i32.const 0xffff))))
        (br $loop)
        ...
        (local.set $n (i32.load8_u offset=0x100100 (i32.and (i32.add (local.get $rstp) (i32.const 1)) (i32.const 0xff))))
        (local.set $rstp (i32.and (i32.add (local.get $rstp) (i32.const 2)) (i32.const 0xff)))
        (i32.store8 (i32.and (i32.add (local.get $pc) (local.get $t)) (i32.const 0xffff)) (local.get $n))
        (br $loop)
        ...
        ;;;
        (local.set $rstp (i32.and (i32.add (local.get $rstp) (i32.const 254)) (i32.const 0xff)))
        (i32.store8 offset=0x100100 (local.get $rstp) (i32.and (local.tee $val (local.tee $n (i32.and (i32.add (local.get $pc) (i32.const 2)) (i32.const 0xffff)))) (i32.const 0xff)))
        (i32.store8 offset=0x100100 (i32.and (i32.add (local.get $rstp) (i32.const 1)) (i32.const 0xff)) (i32.shr_u (local.get $val) (i32.const 8)))
        ...
        (local.set $t (i32.load8_s offset=0x100100 (local.get $rstp)))
        (local.set $rstp (i32.and (i32.add (local.get $rstp) (i32.const 255)) (i32.const 0xff)))
        (i32.store8 offset=0x100100 (i32.and (i32.add (local.get $rstp) (i32.const 1)) (i32.const 0xff)) (i32.load8_u (local.tee $mval (i32.and (i32.add (local.get $pc) (local.get $t)) (i32.const 0xffff)))))
        ...
        (local.set $pc (i32.and (i32.add (local.get $pc) (i32.const 2)) (i32.const 0xffff)))
        (br $loop)
        ...
        (local.set $t (i32.load8_s offset=0x100100 (local.get $rstp)))
        (local.set $wstp (i32.and (i32.add (local.get $wstp) (i32.const 254)) (i32.const 0xff)))
        (i32.store8 offset=0x100000 (local.get $wstp) (i32.and (i32.and (local.tee $val (local.get $pc)) (i32.const 0xff)) (i32.const 0xffff)))
        (i32.store8 offset=0x100000 (i32.and (i32.add (local.get $wstp) (i32.const 1)) (i32.const 0xff)) (i32.shr_u (local.get $val) (i32.const 8)))
        (local.set $pc (i32.and (i32.add (local.get $pc) (local.get $t)) (i32.const 0xffff)))
        (br $loop)
